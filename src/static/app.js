          ...
          ? `<div class="participants-section">
              ...
              <ul class="participants-list">
                ${details.participants
                  .map(
                    (participant) =>
                      `<li><span class="participant-email">${participant}</span><button type="button" class="remove-participant" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}">✖</button></li>`
                  )
                  .join('')}
              </ul>
            </div>`
          : `<div class="participants-section empty"><em>No participants yet. Be the first!</em></div>`;
